...
swift test --disable-sandbox    # full suite, 188 tests (--disable-sandbox no longer required:
...
- **Keep the test count and landed fixes current** in `README.md` /
  ...
  The suite is 188 tests (Rust-core parity + worker-pool tests removed in
